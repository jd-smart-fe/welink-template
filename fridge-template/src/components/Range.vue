<template>
  <div :class="['c-range', disabled ? 'disabled' : '']">
    <!-- <input type="text"
      :value="currentValue"
    > -->
...
<script>
  const BAR_ICON = require('../assets/img/bar.png');
...
<style>
  ...
  /*$range-padding-x: calc($range-slide-button-size/2);*/
  $range-padding-x: 0;
  /*$range-slide-button-border: 0.02rem;*/
  $range-slide-button-border: 0rem;
  $range-slide-stepdot-size: 0.04rem;
  $range-slide-dot-size: 0.24rem;

  $t-range-defcolor: #eee;
  $t-range-lightcolor: #f16a13;
  ...
  .c-range-slider-button{
    ...
    background: url('../assets/img/bar.png') center center;
